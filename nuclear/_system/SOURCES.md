...
1. **WNN RSS**——一次取得 40 則、涵蓋主題二至七的多數線索
2. **核安會與台電 JSON**——台灣機組狀態與管制作為，本站的在地基準
3. **JAIF**——日本官方與產業
4. **ANS Nuclear Newswire**——美國產業與研究動態，**2026-08-23 提前至此**
5. 其餘依主題順序補齊

**ANS 提前的理由**：該站原僅列於清單而未在順序中指名，實際巡檢時排在末段，
額度常已被前面來源用盡。實測其內容密度與時效不低於 JAIF，2026-08-21 當日
即有「用過燃料研究中心：建立貯存與運輸的信心」「Global 2026 國內濃縮擴產」
「ORNL 新實驗室加速 U-233 清理與 Ac-225 供應」等條目，涵蓋用過燃料、
燃料循環與同位素三個方向，值得在額度未用盡時先取。

WNN RSS 與 ANS 均只當線索，看到值得寫的條目仍須點進原文確認，並引用最原始的出處
（管制機關文件優於產業媒體，產業媒體優於二手轉載）。
**ANS 為美國核能學會所辦，屬學會媒體而非中立第三方**，其對產業前景的評述
依編輯規範第三節視為立場方陳述，不單獨採用。
...
- 2026-08-19（創刊日修正）：台電「核能發電」頁實際回傳僅為導覽選單，無機組資料，
  ...
  JAIF RSS（無條目）。
- 2026-08-23：ANS Nuclear Newswire 於巡檢順序中提前至第四位。該站原已列於清單
  （核能相關動態與美國分區各一），但順序中未指名，實際排在末段而額度常被用盡，
  連續兩日未產生條目。以 WebFetch 複測確認其時效與密度不低於 JAIF，故提前。
  同時註明其為美國核能學會所辦，屬學會媒體，對產業前景的評述視為立場方陳述。
